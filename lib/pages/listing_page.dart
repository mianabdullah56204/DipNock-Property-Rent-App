...
import 'package:app/widgets/listing_card.dart'; // Adjust import path if needed
...
const List<Map<String, dynamic>> localDummyListings = [
  {
    ...
    'isFavorite': false,
    'description': 'Detailed description for listing 1...',
    'type': 'Apartment',
    'purpose': 'Rent'
  },
  {
    ...
    'isFavorite': true,
    'description': 'Detailed description for listing 2...',
    'type': 'Apartment',
    'purpose': 'Rent'
  },
  {
    ...
    'agencyLogo': null,
    'isFavorite': false,
    'description': 'Detailed description for listing 3...',
    'type': 'Villa',
    'purpose': 'Rent'
  },
  {
    ...
    'agencyLogo': 'assets/agency_logo.png',
    'isFavorite': false,
    'description': 'Detailed description for listing 4...',
    'type': 'Villa',
    'purpose': 'Rent'
  },
...
class _ListingPageState extends State<ListingPage> {
  ...
  List<Map<String, dynamic>> get _sourceList =>
      widget.allListings ?? localDummyListings;
  ...
  void _applyAllFilters() {
    List<Map<String, dynamic>> results =
        List.from(_sourceList); // Start with source
    ...
    _filters.forEach((key, value) {
      ...
      switch (key) {
        case 'purpose':
          results = results
              .where((listing) =>
                  listing['purpose']?.toString().toLowerCase() ==
        ...
        case 'location':
          if (value is List<String>) {
            ...
            results = results
                .where((listing) =>
                    listing['location']?.toString().toLowerCase() ==
                    value.toString().toLowerCase())
                .toList();
          }
          break;
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: PreferredSize(
          preferredSize: Size.fromHeight(_filters.isNotEmpty
              ? 100
              : 55), // Adjust height: more space needed if chips are present
          child: Column(
